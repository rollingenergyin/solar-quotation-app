  ...
  return (
    <div className="p-6 lg:p-8 w-full max-w-[1400px]">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-xl font-bold text-gray-900">Sales Bills</h1>
        <Link href="/admin/finance/sales-bills/new" className="px-4 py-2 rounded-lg bg-blue-600 text-white text-sm font-medium">
          + Add Bill
        </Link>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
          {bills.length === 0 ? (
            <div className="p-8 text-center text-gray-500">No sales bills yet.</div>
          ) : (
