...
const DEFAULT_TEMPLATES = [
  ...
  },
  {
    ...
    introLetterBody: [
      ...
      'This proposal has been prepared after careful consideration of your business energy consumption, roof space availability, and local grid conditions. The system outlined herein is designed to significantly reduce your electricity costs, contribute to a cleaner environment, and deliver a strong financial return over its 30-year operational life.',
